...
class Settings(BaseSettings):
    ...
    # `publish_wipe_poll_s` until the collection reads empty, and gives up (nothing written) after this long.
    publish_wipe_settle_timeout_s: float = Field(default=180.0, ge=0.0)
